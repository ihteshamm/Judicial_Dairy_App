...
export const Dictionary = require("../assets/icons/dictionary.png");
...
export const searchIcon = require("../assets/icons/searchIcon.jpg");
export const request = require("../assets/icons/request.png");
